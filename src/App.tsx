  ...
  return (
    <main className="container">
      ...
      <section className="about">
        <p>
          As a software developer and artist, I thrive on creation, experimentation, and continuous
          learning.
        </p>
        <p>
      ...
      <h1 className="text-3xl underline text-red-500 bg-blue-500">Hello world!</h1>

      <nav className="social-links">
        <a href="https://github.com/sin2" target="_blank" rel="noopener noreferrer">
          GitHub
        </a>
        <a href="http://www.linkedin.com/in/ssivapat" target="_blank" rel="noopener noreferrer">
          LinkedIn
        </a>
